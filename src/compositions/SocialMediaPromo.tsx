...
/* ── Hook: big bold text with neon glow ───────────────────── */
    ...
    <AbsoluteFill style={{ opacity: fadeOut }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {scene.body && !scene.body.includes('|') && (
          <div style={{
            fontFamily: font, fontWeight: 400, fontSize: 28, color: '#A3A3A3',
...
/* ── Value Grid: 2x2 card grid with icons ─────────────────── */
    ...
    <AbsoluteFill style={{ opacity: fadeOut }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        ...
        <div style={{
          ...
          <GradientText from="#F5F5F5" to={scene.accentColor} fontSize={36} fontFamily={font} fontWeight={weight}
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: font, fontWeight: 600, fontSize: 18, color: '#F5F5F5' }}>
                    {item.text}
                  </span>
                </div>
              </div>
  ...
  return (
    <AbsoluteFill style={{ opacity: fadeOut }}>
      ...
      <div style={{
        ...
        <NeonText color="#F5F5F5" fontSize={50} fontFamily={font} fontWeight={weight}
          glowIntensity={0.8} style={{ textAlign: 'center', marginBottom: 28 }}>
          {scene.headline}
        </NeonText>
        ...
        {scene.body && (
          <div style={{ transform: `scale(${pulse})` }}>
            <div style={{
              ...
              <span style={{ fontFamily: font, fontWeight: 700, fontSize: 22, color: '#FFFFFF' }}>
                {scene.body}
              </span>
            </div>
          </div>
